...
export const supabaseAuthEnabled = import.meta.env.VITE_AUTH_PROVIDER === "supabase";

export function AuthProvider({ children }: { children: React.ReactNode }) {
  if (supabaseAuthEnabled) return <SupabaseAuthProvider>{children}</SupabaseAuthProvider>;
